Feature: US-024: Información meteorológica
    Como usuario, quiero recibir información meteorológica basada en mi ubicación para planificar mis actividades agrícolas, de manera que pueda tomar decisiones informadas sobre el riego, la siembra y la cosecha.
  ...
  Scenario Outline: Escenario 1: Recepción de información meteorológica diaria
    ...
    Then el sistema debe enviar actualizaciones diarias sobre las condiciones meteorológicas (como temperatura, precipitaciones y humedad) para la ubicación seleccionada, incluyendo pronósticos a corto y largo plazo.
