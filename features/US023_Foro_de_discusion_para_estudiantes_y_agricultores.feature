Feature: US-023: Foro de discusión para estudiantes y agricultores
    Como estudiante, quiero colaborar y compartir conocimientos con agricultores a través de foros, para intercambiar experiencias y aprender sobre prácticas agrícolas directamente 
  ...
  Scenario Outline: Escenario 1: Publicación y colaboración en un foro
    ...
    Then el sistema debe permitir que otros estudiantes y agricultores respondan o colaboren en la discusión, mostrando las respuestas en tiempo real y permitiendo que el autor marque 
    una respuesta como útil o resuelta.
  ...
  Scenario Outline: Escenario 2: Búsqueda de temas específicos en el foro
    ...
    Then el sistema debe mostrar una lista de discusiones previas que coincidan con el término de búsqueda, permitiendo al estudiante unirse a la discusión o iniciar un nuevo hilo 
