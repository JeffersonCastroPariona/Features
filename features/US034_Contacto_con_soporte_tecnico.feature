Feature: US-034: Contacto con soporte técnico
    Como usuario, quiero poder contactar al soporte técnico para resolver problemas con la aplicación, asegurando que mis inquietudes sean atendidas y que pueda continuar utilizando la plataforma sin inconvenientes.
  ...
  Scenario Outline: Escenario 2: Visualización del estado de la solicitud
    ...
    Then el sistema debe mostrar una lista de las solicitudes enviadas, incluyendo el estado actual de cada una (pendiente, en proceso, resuelta) y la opción de agregar comentarios si es necesario.
