Feature: US-035: Sección de Preguntas Frecuentes
    Como usuario, quiero acceder a una sección de preguntas frecuentes para resolver problemas comunes, lo que me permitirá encontrar respuestas 
    rápidamente sin necesidad de contactar al soporte técnico.
  ...
  Scenario Outline: Escenario 2: Búsqueda de preguntas específicas
    ...
    Then el sistema debe mostrar las preguntas y respuestas que coinciden con la búsqueda, permitiendo al usuario encontrar la información 
    que necesita de manera eficiente.
