Feature: US-026: Informes detallados de clima
    Como estudiante, quiero consultar informes detallados sobre el impacto del clima en los cultivos, para entender cómo las condiciones meteorológicas 
    afectan el rendimiento agrícola y aplicar estos conocimientos en mis estudios.
  ...
  Scenario Outline: Escenario 1: Consulta de informes de impacto climático en cultivos
    ...
    Then el sistema debe generar un informe detallado sobre el impacto de las condiciones climáticas (como precipitaciones, temperatura y humedad) en ese 
    cultivo, mostrando gráficos y datos históricos relevantes.
