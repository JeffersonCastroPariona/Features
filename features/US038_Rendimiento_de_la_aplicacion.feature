Feature: US-038: Rendimiento de la aplicación
    Como usuario, quiero que la aplicación cargue rápidamente, incluso con una conexión a Internet limitada, para poder acceder a la 
    información y funcionalidades sin interrupciones ni frustraciones.
  ...
  Scenario: Escenario 2: Optimización de recursos para conexiones lentas
    ...
    Then el sistema debe utilizar técnicas de optimización (como carga diferida o compresión de datos) para reducir el tamaño de los
    archivos y minimizar el tiempo de carga, manteniendo la usabilidad de la aplicación.
